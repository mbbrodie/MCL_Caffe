...
void ODRandomAwardBMultinomialLogisticLossLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void ODRandomAwardBMultinomialLogisticLossLayer<Dtype>::Reshape(
...
template <typename Dtype>
void ODRandomAwardBMultinomialLogisticLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
  int n_pred = bottom.size()-1;
...
template <typename Dtype>
void ODRandomAwardBMultinomialLogisticLossLayer<Dtype>::Backward_cpu(
...
INSTANTIATE_CLASS(ODRandomAwardBMultinomialLogisticLossLayer);
REGISTER_LAYER_CLASS(ODRandomAwardBMultinomialLogisticLoss);
}  // namespace caffe
